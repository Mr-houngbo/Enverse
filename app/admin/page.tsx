...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-black py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 text-center">
          <button
            ...
            className="text-orange-600 dark:text-orange-400 hover:text-orange-800 dark:hover:text-orange-200 text-sm underline"
          >
            Se déconnecter
          </button>
        </div>
