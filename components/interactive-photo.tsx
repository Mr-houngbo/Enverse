...
export function InteractivePhoto({ src, alt, size = 'default' }: InteractivePhotoProps) {
  ...
  return (
    <div className="relative group">
      <div
        ref={cardRef}
        className={`relative mx-auto transition-transform duration-200 ease-out w-full ${
          size === 'large' ? 'max-w-[40rem] h-[28rem] sm:max-w-[44rem] sm:h-[32rem] md:max-w-[48rem] md:h-[36rem]' : 'max-w-[32rem] h-[24rem] sm:max-w-[36rem] sm:h-[28rem] md:max-w-[40rem] md:h-[32rem]'
        }`}
